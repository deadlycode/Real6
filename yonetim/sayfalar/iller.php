	...
	<div class="page-title mt-0 mb-0">
		...
		<div class="crumbs">
			<ul id="breadcrumbs" class="breadcrumb">
				...
				<li><a href="<?php echo $sayfalink;?>">İl / İlçe / Semt</a></li>
				<li class="active"><a href="<?php echo $sayfalink;?>">İller</a></li>
			</ul>
		</div>
	</div>
</div> 
		...
		<div class="row mb-3">
			<div class="col-lg-12">
				<div class="btn-toolbar" role="toolbar">
					<a href="" data-toggle="modal" data-target="#il-ekle" data-backdrop="static" data-keyboard="false" class="btn btn-primary btn-sm mr-1">
						<i class="icon-plus font-12"></i> <?=@$admindil['txt66'];?>
					</a>
					<div class="dropdown mr-1">
						...
						<div class="dropdown-menu p-0 min-width-full" aria-labelledby="dropdownMenuSizeButton3">
							<button class="dropdown-item p-2 cursor-pointer" type="submit" name="il_tumu"><i class="icon-trash"></i> Seçilenleri Sil</button>
						</div>
					</div>
					<a href="../_class/il_ilce_semt.php?iltumunusil=ok" title="Tüm Veriyi Sil" class="btn btn-danger btn-sm mr-1 popconfirm">
...
<!-- Yeni iL Ekle !-->
<div class="modal fade" id="il-ekle" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header p-2 pl-2">
				<h5 class="modal-title" id="ModalLabel">Yeni İl Ekle</h5>
			</div>
			...
			<div class="modal-body text-left">
				<div class="form-group row mb-1">
					...
					<div class="col-md-9">
						<input type="text" class="form-control form-control-sm" name="il_adi">
					</div>
				</div>					
			</div>
			<div class="modal-footer">
				<button type="submit" name="il_ekle" class="btn btn-primary btn-icon-text p-2"><i class="fa fa-check"></i> Kaydet</button>
...
<?php 
mesaj("il_ekle",1,"yes","Başarı ile eklenmiştir.");
mesaj("il_ekle",2,"no","Hata oluştu tekrar deneyiniz.!");
mesaj("il_guncelle",1,"yes","Başarı ile guncellenmiştir.");
mesaj("il_guncelle",2,"no","Hata oluştu tekrar deneyiniz.!");
mesaj("ilsil",1,"yes","Başarı ile silinmiştir.");
mesaj("ilsil",2,"no","Hata oluştu tekrar deneyiniz.!");
mesaj("il_tumu",1,"yes","Seçilen kayıtlar başarıyla silinmiştir.");
mesaj("il_tumu",2,"no","Hata oluştu tekrar deneyiniz.!");
mesaj("iltumunusil",1,"yes","Tüm kayıtlar başarıyla silinmiştir.");
mesaj("iltumunusil",2,"no","Hata oluştu tekrar deneyiniz.!");
