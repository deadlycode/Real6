...
echo "\r\n\t\t\t\t\t</select>\r\r\n\t\t\t\t\t</div>\r\r\n\t\t\t\t\t<div class=\"form-group\">\r\r\n\t\t\t\t\t\t<label for=\"diger\">Harici E-Posta Adresleri <small class=\"text-danger\">virgüllerle ayırınız</small></label>\r\r\n\t\t\t\t\t\t<textarea id=\"diger\" name=\"diger\" class=\"form-control\" rows=\"6\"></textarea>\r\r\n\t\t\t\t\t</div>\r\r\n\t\t\t\t\t<div class=\"form-group\">\r\r\n\t\t\t\t\t\t<label for=\"adi\">İçerik</label>\r\r\n\t\t\t\t\t\t<textarea name=\"aciklama\" id=\"myTextarea\"></textarea>\r\r\n\t\t\t\t\t</div>\r\r\n\t\t\t\t\t<button type=\"submit\" name=\"toplu_email_gonder\" class=\"btn btn-primary btn-icon-text btn-sm\">\r\r\n\t\t\t\t\t\t<i class=\"mdi mdi-file-check btn-icon-prepend\"></i>\r\r\n\t\t\t\t\t\tGÖNDER\r\r\n\t\t\t\t\t</button>\r\r\n\t\t\t\t</form>\r\r\n\t\t\t</div>\r\r\n\t\t</div>\r\r\n\t</div>\r\r\n\r\r\n</div>\r\r\n";
mesaj("toplu_email_gonder", 1, "yes", "Başarı ile gönderilmiştir.");
mesaj("toplu_email_gonder", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("toplu_email_gonder", 3, "bos", "Boş alanlar bıraktınız!");
echo "\r\n";
