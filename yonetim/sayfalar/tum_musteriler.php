...
echo $html;
echo "\" class=\"btn btn-primary btn-sm mr-1\">\r\r\n\t\t\t\t\t\t<i class=\"icon-plus font-12\"></i> ";
echo $admindil["txt147"];
echo "\r\n\t\t\t\t\t</a>\r\r\n\t\t\t\t\t<div class=\"dropdown\">\r\r\n\t\t\t\t\t\t<button class=\"btn btn-primary btn-sm dropdown-toggle\" type=\"button\" id=\"dropdownMenuSizeButton3\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\r\r\n\t\t\t\t\t\t\t<i class=\"icon-options-vertical font-12\"></i> Seçilenlere Uygula\r\r\n\t\t\t\t\t\t</button>\r\r\n\t\t\t\t\t\t<div class=\"dropdown-menu p-0 min-width-full\" aria-labelledby=\"dropdownMenuSizeButton3\">\r\r\n\t\t\t\t\t\t\t<button class=\"dropdown-item p-2 cursor-pointer\" type=\"submit\" name=\"musteri_aktif\"><i class=\"icon-check\"></i> Seçilenleri Aktif Et</button>\r\r\n\t\t\t\t\t\t\t<button class=\"dropdown-item p-2 cursor-pointer\" type=\"submit\" name=\"musteri_pasif\"><i class=\"icon-close\"></i> Seçilenleri Pasif Et</button>\r\r\n\t\t\t\t\t\t\t<button class=\"dropdown-item p-2 cursor-pointer\" type=\"submit\" name=\"musteri_engel\"><i class=\"icon-control-pause\"></i> Seçilenleri Engelle</button>\r\r\n\t\t\t\t\t\t\t<button class=\"dropdown-item p-2 cursor-pointer\" type=\"submit\" name=\"musteri_tumu\"><i class=\"icon-trash\"></i> Seçilenleri Sil</button>\r\r\n\t\t\t\t\t\t</div>\r\r\n\t\t\t\t\t</div>\r\r\n\t\t\t\t</div>\r\r\n\t\t\t</div>\r\r\n\t\t</div>\r\r\n\t\t\r\r\n\t\t<div class=\"row\">\r\r\n\t\t\t<div class=\"col-12\">\r\r\n\t\t\t\t<div class=\"table-responsive\">\r\r\n\t\t\t\t\t<table id=\"order-listingg\" class=\"table table-bordered table-hover\">\r\r\n\t\t\t\t\t\t<thead class=\"headbg\">\r\r\n\t\t\t\t\t\t\t<tr>\r\r\n\t\t\t\t\t\t\t\t<th class=\"noshort\" style=\"width:20px;\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Tümünü Seç\">\r\r\n\t\t\t\t\t\t\t\t\t<input id=\"checkbox-4\" class=\"select-all checkbox-custom\" type=\"checkbox\" style=\"width:100px;\">\r\r\n\t\t\t\t\t\t\t\t\t<label for=\"checkbox-4\" class=\"checkbox-custom-label mb-0\"><span class=\"checktext\"></span></label>\r\r\n\t\t\t\t\t\t\t\t</th>\r\r\n\t\t\t\t\t\t\t\t<th style=\"min-width: 100px;\">Adı Soyadı</th>\r\r\n\t\t\t\t\t\t\t\t<th>E-Mail Adresi</th>\r\r\n\t\t\t\t\t\t\t\t<th>Kayıt Tarihi</th>\r\r\n\t\t\t\t\t\t\t\t<th style=\"width:70px;\" class=\"text-center\">Durum</th>\r\r\n\t\t\t\t\t\t\t\t<th style=\"width:115px;\" class=\"text-center\">İşlem</th>\r\r\n\t\t\t\t\t\t\t</tr>\r\r\n\t\t\t\t\t\t</thead>\r\r\n\t\t\t\t\t\t<tbody></tbody>\r\r\n\t\t\t\t\t</table>\r\r\n\t\t\t\t</div>\r\r\n\t\t\t</div>\r\r\n\t\t</div>\r\r\n\t</div>\r\r\n\t</form>\r\r\n</div>\r\r\n<script>\r\r\n\t\$(document).ready(function(){\r\r\n\t\tvar dataTable=\$('#order-listingg').DataTable({\r\r\n\t\t\t\"processing\": true,\r\r\n\t\t\t\"serverSide\":true,\r\r\n\t\t\t\"ajax\":{\r\r\n\t\t\t\turl:\"data/tum_musteriler.php\",\r\r\n\t\t\t\ttype:\"post\"\r\r\n\t\t\t},\r\r\n\t\t\t\"order\": [\r\r\n\t\t\t\t[ 0, \"desc\" ]\r\r\n\t\t\t],\r\r\n\t\t\t\"aLengthMenu\": [\r\r\n\t\t\t\t[5, 10, 15, 5000],\r\r\n\t\t\t\t[5, 10, 15, \"Tümü\"]\r\r\n\t\t\t],\r\r\n\t\t\t\"columnDefs\": [\r\r\n\t\t\t\t{ \"orderable\": false, \"targets\": [0, 5] },\r\r\n\t\t\t\t{  \"className\": \"secili\", targets: [1, 2, 3] },\r\r\n\t\t\t\t{  \"className\": \"secili text-center\", targets: [4] },\r\r\n\t\t\t\t{  \"className\": \"text-center\", targets: [5] }\r\r\n\t\t\t],\r\r\n\t\t\t\"iDisplayLength\": 10,\r\r\n\t\t\t\"language\": {\r\r\n\t\t\t\t\"url\":\"js/Turkish.json\"\r\r\n\t\t\t},\r\r\n\t\t\t\"fnDrawCallback\": function( oSettings ) {\r\r\n\t\t\t\$(\".popconfirm\").popConfirm();\r\r\n\t\t    }\r\r\n\t\t});\r\r\n\t\t\$('#order-listingg').on('click', 'tbody tr td.secili', function(event) {\t\r\r\n\t\t\t\$(this).closest(\"tr\").find(\"td:eq(0)\").find(\"input[type=checkbox]\").trigger('click');\r\r\n\t\t\tif(\$(this).closest(\"tr\").find(\"input[type=checkbox]\").prop(\"checked\")){\r\r\n\t\t\t\t\$(this).closest(\"tr\").addClass('highlight');\r\r\n\t\t\t}else{\r\r\n\t\t\t\t\$(this).closest(\"tr\").removeClass('highlight');\r\r\n\t\t\t}\r\r\n\t\t});\r\r\n\t\t\$(\".select-all\").click(function () {\r\r\n\t\t\t\$(\"input:checkbox\").not(this).prop('checked', this.checked);\r\r\n\r\r\n\t\t\tif(this.checked){\r\r\n\t\t\t\t\$(\"input:checkbox\").not(this).closest(\"tr\").addClass('highlight');\r\r\n\t\t\t}else{\r\r\n\t\t\t\t\$(\"input:checkbox\").not(this).closest(\"tr\").removeClass('highlight');\r\r\n\t\t\t}\t\t\t\r\r\n\t\t});\r\r\n\t});\r\r\n</script>\r\r\n";
mesaj("musteri_ekle", 1, "yes", "Başarı ile eklenmiştir.");
mesaj("musteri_ekle", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musterisil", 1, "yes", "Başarı ile silinmiştir.");
mesaj("musterisil", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musteri_tumu", 1, "yes", "Seçilen kayıtlar başarıyla silinmiştir.");
mesaj("musteri_tumu", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musteritumunusil", 1, "yes", "Tüm kayıtlar başarıyla silinmiştir.");
mesaj("musteritumunusil", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musteri_aktif", 1, "yes", "Bilgileriniz başarıyla güncellendi.");
mesaj("musteri_aktif", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musteri_pasif", 1, "yes", "Bilgileriniz başarıyla güncellendi.");
mesaj("musteri_pasif", 2, "no", "Hata oluştu tekrar deneyiniz.!");
mesaj("musteri_engel", 1, "yes", "Bilgileriniz başarıyla güncellendi.");
mesaj("musteri_engel", 2, "no", "Hata oluştu tekrar deneyiniz.!");
