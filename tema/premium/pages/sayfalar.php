                ...
                <div class="blog-details single-post-item format-standard">
                    <div class="post-details">
                        ...
                        <div class="post-featured-img">
                            <img class="img-fluid img-responsive" src="<?php echo tema;?>/uploads/sayfalar/<?php echo $Sonuc['resim'];?>" alt="<?php echo $Sonuc['adi'];?>" >
                        </div>    
						<?php } ?>		
                        <h2 class="post-title"><?php echo $Sonuc['adi'];?></h2>
