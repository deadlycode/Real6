    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <h2 class="ipt-title"><?=@$dil['yaz18'];?></h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 list-layout">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="filter-fl">
                            <h4><?=@$dil['yaz19'];?> <span class="theme-cl"> <?=$total;?></span></h4>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="property-listing property-1">
                                ...
                                <div class="listing-img-wrapper">
                                    <a href="<?=$ilanUrl;?>">
                                        <img src="<?php echo tema;?>/uploads/emlaklar/<?=$BSonuc['kapak'];?>" class="img-fluid mx-auto" alt="<?=$BSonuc['adi'];?>" />
                                    </a>
                            ...
                            <?php if($limitayar['limit_emlakkategori'] < $total && $limitayar['limit_emlakkategori'] > 0){
                                ...
                                for($i= $page - $showing; $i < $page + $showing + 1; $i++){
                                    if($i > 0 and $i <= $page_count){
                                        ...
                                        <?php }else{?>
                                            <li class="page-item"><a class="page-link" href="arama?s=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                        <?php }}}if($page != $page_count){?>
                                    <?php  $next = $page +1;?>
                                    <li class="page-item">
                                        <a class="page-link" href="arama?s=<?php echo $next; ?>" aria-label="Next">
                ...
                <div class="page-sidebar">
                    ...
                    <div class="sidebar-widgets">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                <div class="input-with-icon">
                                    <input type="text" class="form-control" placeholder="Kelime" name="kelime" value="<?php if(isset($post['filtre_uygula'])){ echo $post['kelime']; }?>">
                                    <i class="ti-search"></i>
                                </div>
                            </div>
