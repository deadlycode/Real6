				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title"><?=@$dil['yaz66'];?></h2>
			...
			<section>
				...
				<?php if($BSorgu->rowCount()){?>				
					...
					<div class="row">						
						...
						<div class="col-lg-<?php echo $limitayar['limit_belge'];?> col-md-<?php echo $limitayar['limit_belge'];?> col-sm-12">
							<div class="agents-grid">
								<div class="agents-grid-wrap">									
									<div class="fr-grid-thumb">
										<a href="<?php echo tema;?>/uploads/belgeler/<?php echo $BSonuc['resim']; ?>" class="mfp-gallery">											
											<img src="<?php echo tema;?>/uploads/belgeler/<?php echo $BSonuc['resim']; ?>" class="img-fluid mx-auto" alt="<?php echo $BSonuc['adi']; ?>" title="<?php echo $BSonuc['adi']; ?>" />
										</a>
									</div>									
								</div>							
					...
					<div class="row">
						...
						<?php $previous = $page - 1;?>
								<li class="page-item">
									<a class="page-link" href="<?php echo $htc['belgeurl'];?>/<?php echo $previous;?><?php echo $html;?>" aria-label="Previous">
								...
								<?php }else{?>								
								<li class="page-item"><a class="page-link" href="<?php echo $htc['belgeurl'];?>/<?php echo $i; ?><?php echo $html;?>"><?php echo $i; ?></a></li>
								<?php }}}if($page != $page_count){?>
								<?php  $next = $page +1;?>
								<li class="page-item">
									<a class="page-link" href="<?php echo $htc['belgeurl'];?>/<?php echo $next; ?><?php echo $html;?>" aria-label="Next">
