...
if (isset($_POST["emlak_ekle"])) {
    if ($ayar["demo"] == 0) {
        ...
        $Ekle = $sorgu->execute([$brut, $ekleyen, $uye, $net, $oda, $video, $katsayisi, $bulundugukat, $bina, $isitma, $banyo, $balkon, $esya, $kdrumu, $takas, $krediu, $garama, $imardurumu, $adano, $parselno, $paftano, $kaks, $gabari, $tapudurumu, $katkarsiligi, $aidat, $depozito, $pbirim, $il, $ilce, $semt, $latfield, $lngfield, $zoom, $kategori, $danisman, $ozellikler, $adi, $emlak_kodu, $fiyat, $seo, $aciklama, $description, $keywords, $Kapak, $Katalog, $durum, $anasayfa, $_SESSION["k_dil"], $tarih]);
        if ($Ekle) {
            ...
            if ($_POST["uye"] == "1") {
                sitebildirim("" . $_POST["uyeadsoyad"] . "", "icon-drawer", $last_id, $adi, "başlıklı ilan ekledi.");
                $_SESSION["emlak_ekle"] = "yes";
                header("Location:../ilan-ekle" . $html . "");
                exit;
            }
...
if (isset($_POST["emlak_guncelle"])) {
    ...
    if ($ayar["demo"] == 0) {
        ...
        $guncelle = $sorgu->execute([$ekleyen, $uye, $brut, $net, $oda, $video, $katsayisi, $bulundugukat, $bina, $isitma, $banyo, $balkon, $esya, $kdrumu, $takas, $krediu, $garama, $imardurumu, $adano, $parselno, $paftano, $kaks, $gabari, $tapudurumu, $katkarsiligi, $aidat, $depozito, $pbirim, $il, $ilce, $semt, $latfield, $lngfield, $zoom, $kategori, $danisman, $ozellikler, $adi, $emlak_kodu, $fiyat, $seo, $aciklama, $description, $keywords, $durum, $anasayfa, $tarih, $d_id]);
        if ($guncelle) {
            $sonid = $_POST["id"];
            foreach ($files as $file) {
                $yukle = new Upload($file);
            ...
            if ($_POST["uye"] == "1") {
                sitebildirim("" . $_POST["uyeadsoyad"] . "", "icon-drawer", $last_id, $adi, "başlıklı ilanı Güncelledi.");
                $_SESSION["emlak_ekle"] = "yes";
                header("Location:../ilan-ekle/" . $d_id . "" . $html . "");
                exit;
            }
            $last_id = $d_id;
